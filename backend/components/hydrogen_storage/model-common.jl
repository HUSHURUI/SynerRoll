# ═══════════════════════════════════════════════════════════════════════════
# hydrogen_storage/model-common.jl — 共享函数
#
# model-base.jl 和 model.jl 共用的参数解析与辅助函数
# ═══════════════════════════════════════════════════════════════════════════

function resolve_hydrogen_storage_params(component::HydrogenStorage, ctx::BuildContext)
...
function derive_hydrogen_storage_state(planned_input::Vector{Float64}, planned_output::Vector{Float64})
    return [
